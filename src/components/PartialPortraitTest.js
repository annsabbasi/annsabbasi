...
//             // Slightly larger scale for better detail
//             const scale = 0.9;
...
//             // Much denser particle sampling for clearer details
...
//                     // Only render visible pixels (respects transparent bg)
//                     if (a > 50) {
//                         const brightness = (r + g + b) / (3 * 255);

//                         // Smaller particle sizes for sharper detail
//                         // Darker areas (like eyes, hair) get slightly larger particles for definition
//                         const particleSize = size <= 280
//                             ? 0.6 + brightness * 0.8
//                             : 0.8 + brightness * 1.0;

//                         // Random scatter for initial animation
...
//                             b: b,
//                             a: a,
//                             baseAlpha: (a / 255) * (0.85 + brightness * 0.15),
//                             currentAlpha: 0,
...
//                 canvasWidth / 2, canvasHeight / 2, canvasWidth * 0.35,
//                 canvasWidth / 2, canvasHeight / 2, canvasWidth * 0.7
//             );
//             gradient.addColorStop(0, "rgba(10, 25, 47, 0)");
//             gradient.addColorStop(1, "rgba(10, 25, 47, 0.25)");
...
// export default ParticlePortraitTest;
